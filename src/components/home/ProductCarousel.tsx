...
export default function ProductCarousel({ products, activeIndex, setActiveIndex }: ProductCarouselProps) {
    ...
    return (
        <motion.div
            ...
            className="absolute bottom-0 left-0 w-full h-[32vh] md:h-[40vh] z-20 flex items-start pt-3 md:pt-6 bg-[#FAF8F5]/65 backdrop-blur-xl border-t border-[#C5A880]/25 shadow-[0_-10px_40px_rgba(0,0,0,0.03)]"
        >
            <div
                ref={containerRef}
