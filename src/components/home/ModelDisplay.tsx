...
export default function ModelDisplay({ products, activeIndex, show }: ModelDisplayProps) {
    ...
    return (
        <div className="absolute top-0 left-0 w-full h-[85vh] z-10 flex items-end justify-center pointer-events-none overflow-hidden">
                ...
                {products.map((product, idx) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className={cn(
                                "absolute bottom-0 flex justify-center items-end origin-bottom w-[200px] md:w-[280px] transition-all duration-500",
                                isCenter 
                                    ? "h-[75vh] md:h-[82.5vh]" 
                                    : "h-[50vh] md:h-[55vh]"
                            )}
