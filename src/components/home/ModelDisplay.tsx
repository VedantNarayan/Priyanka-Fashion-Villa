            ...
            <div className="relative w-full max-w-[1200px] h-full flex justify-center items-end">
                {products.map((product, idx) => {
                    ...
                    return (
                        <motion.div
                            key={product.id}
                            initial={{ opacity: 0, x: offset * carouselSpacing, scale: isCenter ? 1.4 : 0.8 }}
                            animate={{
                                opacity: isVisible ? 1 : 0,
                                x: offset * carouselSpacing,
                                scale: isCenter ? 1.4 : 0.8,
                            ...
                            className="absolute bottom-[5vh] md:bottom-0 flex justify-center items-end origin-bottom h-[52vh] md:h-[55vh] w-[200px] md:w-[280px]"
                        >
