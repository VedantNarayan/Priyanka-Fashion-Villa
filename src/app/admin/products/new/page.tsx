...
import { addProduct, uploadProductImageWithBgRemoval } from "@/app/actions/products";
import { getBgRemovalStats } from "@/app/actions/bg-removal-stats";
import Link from "next/link";
import { ArrowLeft, Save, Upload, X, Loader2, Sparkles, Ruler, Plus, Trash2 } from "lucide-react";
    ...
    const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            if (result.url) {
                ...
                // Refresh stats after BG removal
                if (result.bgRemoved) {
                    getBgRemovalStats().then(setBgStats).catch(() => {});
                }
            }
            ...
            <form action={formAction} className="bg-white p-8 rounded-sm shadow-sm space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <p className="text-xs text-stone-500">First 2 images get <strong className="text-amber-600">AI background removal</strong> automatically. Remaining images upload as-is.</p>
                    </div>
